...
Source = [('C0', 'C6'),('C2', 'C3'),('C2', 'C3'),('C3', 'C4'),('C0', 'C5'),('C5', 'C0'),('C0', 'C5'),('C3', 'C5'),('C1', 'C3'),
          ('C6', 'C4'),('C6', 'C3'),('C1', 'C2'),('C2', 'C0'),('C4', 'C1'),('C2', 'C3'),('C2', 'C4'),('C6', 'C4'),('C2', 'C3'),
          ('C3', 'C2'),('C1', 'C0'),('C3', 'C2'),('C6', 'C2'),('C3', 'C5'),('C3', 'C2'),('C4', 'C6'),('C6', 'C4'),('C4', 'C6'),
          ('C4', 'C3'),('C5', 'C0'),('C6', 'C4'),('C5', 'C0'),('C2', 'C5'),('C5', 'C6'),('C2', 'C0'),('C0', 'C5'),('C5', 'C2'),
          ('C4', 'C1'),('C0', 'C5'),('C3', 'C2'),('C2', 'C3'),('C6', 'C4'),('C2', 'C5')]


mycombination = Source[CIndex][0] + Source[CIndex][1] + '_' + Permutation[CIndex][0] + Permutation[CIndex][1] # e.g.C0C1_C0C1 #compare C0C1 #change3
...
for i in range(10):
    fold = 'fold'+ str(i)
    # prediction
    model_f = prefix+ fold + '/models/Final_model'+ mycombination +"_Full_1v1.h5" #test
    #model_f = prefix + fold + '/control/model' + mycombination + "_Full_1v1.h5" #control
...
plt.savefig('./shap_bar_Shapley_10fold_Average_'+ mycombination + '.pdf') #change4
